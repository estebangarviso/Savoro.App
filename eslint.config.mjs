...
const SRC_GLOB = ['**/*.{js}'];
const CODE_STYLE_GLOB = '**/*.{js,css,json,md}';
...
export default defineConfig([
  {
    ignores: ['node_modules/', 'staticfiles/', '*.min.js', 'venv/', '*.pyc', '__pycache__/'],
  },
  // #region ecmascript
  {
    files: [SRC_GLOB],
    ...
    rules: {
      ...
      'perfectionist/sort-objects': [
        WARN,
        {
          ...
          groups: ['top', 'member', 'multiline-member', 'method', 'multiline-method', 'unknown'],
        },
      ],
    },
    settings: {
